...
const VERDICT_RU: Record<string, string> = {
  ...
  'Clean air (EAQI "good").': 'Чистый воздух (EAQI «хорошо»).',
  'Acceptable air (EAQI "fair").': 'Приемлемый воздух (EAQI «удовлетворительно»).',
  'Polluted air (EAQI "poor").': 'Загрязнённый воздух (EAQI «плохо»).',
  'Moderate air (EAQI "moderate").': 'Умеренное качество воздуха (EAQI «умеренно»).',
  'Heavy pollution (EAQI "very poor").': 'Сильное загрязнение (EAQI «очень плохо»).',
...
const VERDICT_ES: Record<string, string> = {
  ...
  'Clean air (EAQI "good").': 'Aire limpio (EAQI «bueno»).',
  'Acceptable air (EAQI "fair").': 'Aire aceptable (EAQI «regular»).',
  'Polluted air (EAQI "poor").': 'Aire contaminado (EAQI «malo»).',
  'Moderate air (EAQI "moderate").': 'Aire moderado (EAQI «moderado»).',
  'Heavy pollution (EAQI "very poor").': 'Fuerte contaminación (EAQI «muy malo»).',
